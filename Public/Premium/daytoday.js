...
window.addEventListener("DOMContentLoaded", async()=> {
    try{
      ...
      const links = await axios.get("http://100.27.0.10:4000/user/downloadlink", { headers: {"Authorization" : token }})
...
async function onDownload(){
    try{
        const response = await axios.get('http://100.27.0.10:4000/user/download', { headers: {"Authorization" : token} })
